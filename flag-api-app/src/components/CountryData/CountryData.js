...
class countryData extends Component {
	render() {
		...
		// console.log(new Date(this.props.cases.updated).toLocaleString('en-IN'));
		...
		return (
			<div className={classes.CountryData}>
				<img alt={this.props.countryData.name} src={this.props.countryData.flag} className={classes.img} />
				<div className={classes.Body}>
					<h2 className={this.props.Dark ? classes.DarkcardBodyHeading : classes.CardBodyHeading}>
					...
					<div className={classes.Section_1}>
						<h5>
							...
							<span className={valueClassList.join(' ')}>{this.props.countryData.nativeName}</span>
						</h5>
						<h5>
						...
						<h5>
							...
							<span className={valueClassList.join(' ')}>{this.props.countryData.region}</span>
						</h5>
						<h5>
							<span className={keyClassList.join(' ')}>Sub Region: </span>
							<span className={valueClassList.join(' ')}>{this.props.countryData.subregion}</span>
						</h5>
						<h5>
							<span className={keyClassList.join(' ')}>Capital: </span>
							<span className={valueClassList.join(' ')}>{this.props.countryData.capital}</span>
						</h5>
						{this.props.cases && (
							<h5>
					...
					<div className={classes.Section_2}>
						<h5>
							...
							<span className={valueClassList.join(' ')}>{this.props.countryData.topLevelDomain}</span>
						</h5>
						<h5>
